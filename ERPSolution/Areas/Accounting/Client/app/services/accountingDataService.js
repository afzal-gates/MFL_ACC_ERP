(function () {
    'use strict';
    angular.module('multitex.accounting').factory('AccountingDataService', ['$http', 'exception', '$filter', 'access_token', AccountingDataService]);

    function AccountingDataService($http, exception, $filter, access_token) {
        var self = this;
        var urlBase = '/api/accounting';
