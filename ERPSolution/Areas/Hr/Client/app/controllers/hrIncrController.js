...
(function () {
    ...
    function HrIncrProposalHController(logger, config, HrService, $q, $scope, $http, $location, $state, $stateParams, incrHdrData, $filter) {
        ...
        vm.form = incrHdrData[key] ? incrHdrData : {HR_YR_INCR_H_ID: 0, IS_NEXT: $stateParams.pIS_FROM_BATCH_LIST == 'Y' ? 'Y' : 'N', IS_P_F: 'N', BATCH_APVRL_STATUS: '', USER_LEVEL: '', total: 0, HR_INCR_MEMO_ID: null, LK_FLOOR_ID: null, PROPOSE_BY: null, HR_DEPARTMENT_ID: null, CORE_DEPT_ID: null };
        $scope.form = incrHdrData[key] ? incrHdrData : { HR_YR_INCR_H_ID: 0, IS_NEXT: $stateParams.pIS_FROM_BATCH_LIST == 'Y' ? 'Y' : 'N', IS_P_F: 'N', BATCH_APVRL_STATUS: '', USER_LEVEL: '', total: 0, HR_INCR_MEMO_ID: null, LK_FLOOR_ID: null, PROPOSE_BY: null, HR_DEPARTMENT_ID: null, CORE_DEPT_ID: null };
            ...
            $('<input data-text-field="INCR_GRADE_CODE" data-value-field="HR_INCR_GRADE_ID" data-bind="value:' + options.field + '"/>')
                ...
                .kendoDropDownList({                    
                    ...
                    dataSource: {
                        transport: {
                            read: function (e) {
                                e.success(_.filter(gradeData, function (o) {
