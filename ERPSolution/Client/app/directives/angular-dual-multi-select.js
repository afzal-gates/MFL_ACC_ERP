                    ...
                    '<div class="dualmultiselect">'+
                        ...
                        '<div class="row">' +
                            ...
                            '<div class="col-md-1" style="padding-left:10px">' +                                
                                ...
                                '<label>&nbsp;</label>' +
                                '<label>&nbsp;</label>' +
                                '<button class="btn btn-default btn-xs" ng-click="transfer(options.items, options.selectedItems, -1)"> >> </button>' +
                                '<button class="btn btn-default btn-xs" ng-click="transfer(options.selectedItems, options.items, -1)"> << </button>' +
                            '</div>'+
