...
namespace ERPSolution.Controllers
{
    ...
    public class CommonApiController : ApiController
    {
        ...
        [Route("GmtPartList")]
        [HttpGet]
        // GET :  /api/common/GmtPartList
        public IHttpActionResult GmtPartList(string pRF_GARM_PART_LST = null)
        {
            var obList = new RF_GARM_PARTModel().SelectAll(pRF_GARM_PART_LST);
            return Ok(obList);
        }
